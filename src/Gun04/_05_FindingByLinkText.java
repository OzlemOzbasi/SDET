...
public class _05_FindingByLinkText extends BaseStaticDriver {
    public static void main(String[] args) {
        ...
        WebElement element = driver.findElement(By.linkText("Siparişlerim"));    // SADECE a tag lerinde çalışır , yani  < a > larda
        ...
        WebElement element2 = driver.findElement(By.partialLinkText("Süper Fiyat"));    // SADECE a tag lerinde çalışır , yani  < a > larda
