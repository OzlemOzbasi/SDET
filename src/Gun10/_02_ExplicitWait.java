...
public class _02_ExplicitWait extends BaseStaticDriver {
    public static void main(String[] args) {
        ...
        System.out.println("webDriverText.getText() = " + webDriverText.getText());    // görunenı konsolda yazdırdık
...
/*   KONSOL :
    ...
    webDriverText.getText() = WebDriver
...
/*
    ...
    Her ikisi tanımlı ise : önce Implicit kullanılır, ve üzerine Explicit in süresi eklenerek
                            toplam hata sınır süresi ortaya çıkmış olur.  ( İnterview de bu yanı ımplıcıty suresını uzerıne eklemesı sorulmus )
